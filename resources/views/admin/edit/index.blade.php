...
<form>
    <fieldset class="uk-fieldset">
        ...
        <legend class="uk-legend">Edit</legend>
...
<p uk-margin>
    <button class="uk-button uk-button-default" type="button" onclick="UIkit.notification({message: 'Perubahan berhasil disimpan', pos: 'top-center'})">simpan</button>
</p>
@endsection